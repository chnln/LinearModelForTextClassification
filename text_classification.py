...
if __name__ == '__main__':
    ...
    #     f.write(log_file_name.replace("-", " ") + " {} {}\n".format(df_evals.loc[best_test_index]["test-acc"], df_evals.loc[best_test_index]["test-f1"]))

    # import matplotlib.pyplot as plt
    #
    # plt.plot(df_evals["train-acc"].to_list(), label="train-acc")
    # plt.plot(df_evals["test-acc"].to_list(), label="test-acc")
    # plt.plot(df_evals["train-f1"].to_list(), label="train-f1")
    # plt.plot(df_evals["test-f1"].to_list(), label="test-f1")
